...
from MMTFV_itm_data import get_loader
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from MMTFV_itm_model import VLT5MMTFVITM
        
        model_kwargs = {}
        assert 't5' in args.backbone
        #if 't5' in args.backbone:
        model_class = VLT5MMTFVITM
        ...
        for epoch in range(self.args.epochs):
            ...
            for step_i, batch in enumerate(self.train_loader):
                ...
                if self.verbose:
                    ...
                    pred_ans = results['pred_ans_ids']
                    ques_ids = batch['question_ids']

                    for qid, ans in zip(ques_ids, pred_ans):
                        quesid2ans[qid] = ans
                    train_score_dict = self.train_loader.evaluator.evaluate_train(quesid2ans)
            ...
            if self.verbose:
                ...
                wandb_log_dict['Train/score'] = train_score
...
def main_worker(gpu, args):
    ...
    test_score_dict = trainer.evaluate(test_loader)
    test_acc = test_score_dict['accuracy'] * 100.
    print(f"Test Result: {test_acc}")
