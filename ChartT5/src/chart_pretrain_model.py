...
class VLT5Pretraining(ChartT5):
    ...
    def valid_step(self, batch):
        ...
        if 'table_lmh' in self.losses or 'table_lmd' in self.losses or 'tsp' in self.losses or 'tdp' in self.losses:
            output = self.generate(
                input_ids=input_ids,
                vis_inputs=(vis_feats, vis_pos),
            )
            ...
            results['table_pred'] = generated_sents
