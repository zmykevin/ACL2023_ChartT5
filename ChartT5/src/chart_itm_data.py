...
class ChartITMFinetuneDataset(Dataset):
    def __init__(self, split='train', raw_dataset=None, rank=-1, topk=-1, verbose=True, args=None, mode='train'):
        ...
        self.source_to_h5 = {
            'twitterCOMMS_train': chartitm_dir.joinpath(f'Twitter-COMMS/features/train_chart_elements.h5'),
            'twitterCOMMS_val': chartitm_dir.joinpath(f'Twitter-COMMS/features/val_chart_elements.h5'),
            'twitterCOMMS_test': chartitm_dir.joinpath(f'Twitter-COMMS/features/test_chart_elements.h5'),
            'statista_train': chartitm_dir.joinpath(f'statista/features/train_chart_elements.h5'),
            'statista_val': chartitm_dir.joinpath(f'statista/features/val_chart_elements.h5'),
            'statista_test': chartitm_dir.joinpath(f'statista/features/test_chart_elements.h5'),
            'infographicvqa': infographicitm_dir.joinpath(f'features/boxes36.h5')
        }
