...
def parse_args(parse=True, **optional_kwargs):
    ...
    # New Args
    parser.add_argument("--src_folder", type=str, default='/dvmm-filer2/projects/mingyang/semafor/chart_qa/ChartQA/')
    parser.add_argument('--ocr_tags', action='store_true')
    parser.add_argument('--ocr_position_encoding', type=str, default="oscar_style", choices=['oscar_style', 'ocr_bbox'])
    parser.add_argument('--dataset_name', type=str, default='chartqa')
    parser.add_argument('--visfeat_type', type=str, default="vlt5", choices=['vlt5', 'chart_element'])
    #parser.add_argument('--load_T5', action='store_true')
    parser.add_argument('--table_mlm', action='store_true')
    parser.add_argument("--tableMaskRate", dest='table_mask_rate', default=0.45, type=float)
    parser.add_argument('--scif_num', action='store_true')
    parser.add_argument('--table_flat', action='store_true')
    parser.add_argument('--ocr_copy', action='store_true')

    #numerical modelinng
    parser.add_argument('--num_modeling', action='store_true')
