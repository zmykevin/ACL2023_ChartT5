...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataroot', type=str,
                        default='/dvmm-filer2/projects/mingyang/semafor/infographic_itm')
    ...
    chartsum_img_dir = chartsum_dir.joinpath("images/test_easy")

    dataset_name = 'InfographicITM'
    ...
    if args.proposal_type == "object_detector":
        output_fname = out_dir.joinpath(f'testE_boxes{NUM_OBJECTS}.h5')
        print('features will be saved at', output_fname)
        from detectron2_proposal_maxnms import extract
        extract(output_fname, dataloader, desc)
    elif args.proposal_type == "chart_element":
        output_fname = out_dir.joinpath(f'_chart_elements.h5')
